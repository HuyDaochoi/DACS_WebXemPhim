        ...
        <div class="col-md-4">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="/category/storeQuocGia" method="POST" id="addCountryForm">
                        <div class="mb-3">
                            ...
                            <div class="invalid-feedback">Tên quốc gia phải từ 2-100 ký tự</div>
                        </div>
                        <div class="text-end">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><?php echo $country['MaQuocGia']; ?></td>
                                    <td><?php echo htmlspecialchars($country['TenQuocGia']); ?></td>
                                    <td>
                                        <div class="btn-group">
                                            <button type="button" class="btn btn-warning" 
                                                    onclick="editCountry(<?php echo $country['MaQuocGia']; ?>, '<?php echo htmlspecialchars(addslashes($country['TenQuocGia'])); ?>')"
                                                    title="Sửa">
                                                <i class="fas fa-edit"></i>
                                            </button>
                                            <button type="button" class="btn btn-danger" 
                                                    onclick="deleteCountry(<?php echo $country['MaQuocGia']; ?>)"
                                                    title="Xóa">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="editCountryForm" action="/category/updateQuocGia" method="POST">
                    <input type="hidden" name="id" id="editCountryId">
                    <div class="mb-3">
                        <label for="editCountryName" class="form-label">Tên quốc gia <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="editCountryName" name="name" required minlength="2" maxlength="100">
                        <div class="invalid-feedback">Tên quốc gia phải từ 2-100 ký tự</div>
                    </div>
                </form>
            </div>
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" onclick="submitEditCountry()">Lưu</button>
            </div>
        </div>
    </div>
</div>
...
function deleteCountry(id) {
    if (confirm('Bạn có chắc chắn muốn xóa quốc gia này?')) {
        window.location.href = '/category/deleteQuocGia/' + id;
    }
}
